...
class ModelEvaluation:
    def __init__(self, model_eval_config: ModelEvaluationConfig,  data_validation_artifact: DataValidationArtifact,model_trainer_artifat: ModelTrainerArtifact):
        try:
            self.model_eval_config = model_eval_config
            self.data_validation_artifact = data_validation_artifact
            self.model_trainer_artifact = model_trainer_artifat
    ...
    def initiate_model_evaluation(self)-> ModelEvaluationArtifact:
        try:
            ...
            latest_matric = get_classification_score(y_true, y_latest_pred)

            improved_accuracy = trained_metric.f1_score - latest_matric.f1_score
            ...
            model_evaluation_artifact = ModelEvaluationArtifact(
                ...
                best_model_metric_artifact=latest_matric)
