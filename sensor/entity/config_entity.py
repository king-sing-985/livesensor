...
class TrainingPipelineConfig:
    ...
    def __init__(self, timestamp = datetime.now()):
            ...
            self.data_ingestion_dir = os.path.join(self.artifact_dir,self.timestamp)
            self.data_validation_dir = os.path.join(self.artifact_dir,self.timestamp)
            self.data_validation_dir = os.path.join(self.artifact_dir, self.timestamp)
            self.model_trainer_dir = os.path.join(self.artifact_dir)
            self.model_evaluation_dir = os.path.join(self.artifact_dir)
...
class DataIngestionConfig:
    ...
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.feature_store_file_path: str = os.path.join(training_pipeline_config.data_ingestion_dir, training_pipeline.DATA_INGESTION_FEATURE_STORE_DIR, training_pipeline.FILE_NAME)
        self.training_file_path: str = os.path.join(training_pipeline_config.artifact_dir, training_pipeline.DATA_INGESTION_INGESTED_DIR, training_pipeline.TRAIN_FILE_NAME)
        self.testing_file_path: str = os.path.join(training_pipeline_config.artifact_dir, training_pipeline.DATA_INGESTION_INGESTED_DIR, training_pipeline.TEST_FILE_NAME)
